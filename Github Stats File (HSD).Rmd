...
Weight3.F.Mod <- glm(Sugar.Weight ~ Sex*Crosses, data=subset(dataH, Generation=="F1"))
Weight.F.results.df <- rbind(
  ...
  mutate(sex = "female") %>%
  mutate(exposure = ifelse(grepl("MhPc", term), "Maternal", ifelse(grepl("McPh", term), "Paternal", "Both")))
...
Weight3.M.Mod <- glm(Sugar.Weight ~ Sex*Crosses, data=subset(dataH, Generation=="F1"))
...
CDRslts.df <- rename(CDRslts.df, c("term"="contrast")) %>% mutate(pAdj = p.adjust(p.value, method = "fdr"))
...
write.csv(CDresults, file = "Ch3 Contrasts HSD only TaYTGF (FDR).csv")
```
...
BtwnRslts.df <- rename(BtwnRslts.df, c("lhs"="contrast")) 
...
write.csv(BetweenResults, file = "Crosses Contrasts.csv")
...
write.csv(Results, file = "All Contrasts.csv")
```
...
HplotData <- data.Wt %>% filter(grepl("HSD", Treatment))
HplotData$Crosses <- factor(HplotData$Crosses, levels=c("MhPh", "MhPc", "McPh"))
HplotData$Crosses <- revalue(HplotData$Crosses, c("MhPh"="Parentaline", "MhPc"="Matriline", "McPh"="Patriline"))
...
Female TAG
```{r}
F.1.H.MPB.Ta.plot <- ggplot(subset(HplotData, Sex=="female" & Crosses==c("Parentaline", "Matriline", "Patriline") & variable=="TAG" & Generation=="F1"), aes(x=variable, y=MetabWt, fill=Crosses)) + 
...
F.2.H.MPB.Ta.plot <- ggplot(subset(HplotData, Sex=="female" & Treatment=="HSD" & Crosses==c("Parentaline", "Matriline", "Patriline") & variable=="TAG" & Generation=="F2"), aes(x=variable, y=MetabWt, fill=Crosses)) + 
  ...
  theme(legend.key.size =  unit(2, "in"), legend.text = element_text(size=25), legend.title = element_text(size=28, face="bold"), axis.text=element_text(size=25), axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.title.x = element_text(size=30), plot.title = element_text(size = rel(3), hjust = 0.5)) + 
...
F.3.H.MPB.Ta.plot <- ggplot(subset(HplotData, Sex=="female" & Treatment=="HSD" & Crosses==c("Parentaline", "Matriline", "Patriline") & variable=="TAG" & Generation=="F3"), aes(x=variable, y=MetabWt, fill=Crosses)) + 
...
mylegend<-g_legend(F.1.H.MPB.Ta.plot)

Ta.F.H.plot <- grid.arrange(arrangeGrob(F.1.H.MPB.Ta.plot + theme(legend.position="none"), F.2.H.MPB.Ta.plot + theme(legend.position="none"), F.3.H.MPB.Ta.plot + theme(legend.position="none"), ncol=3, top=textGrob("HSD Females: Triglycerides", gp = gpar(fontface=2, fontsize=40)), bottom=textGrob("", gp = gpar(fontface=1, fontsize=25)), left=textGrob("Triglycerides/Weight (µg)", rot=90, gp = gpar(fontface=1, fontsize=35))), mylegend, ncol=2, widths=c(10,2))

ggsave("HSD F1-3 TAG (rug).png", Ta.F.H.plot, width = 30, height = 10, units = "in")
```
Male TAG
```{r}
#MALE TAG
M.1.H.MPB.Ta.plot <- ggplot(subset(HplotData, Sex=="male" & Treatment=="HSD" & Crosses==c("Parentaline", "Matriline", "Patriline") & variable=="TAG" & Generation=="F1"), aes(x=variable, y=MetabWt, fill=Crosses)) + 
  ...
  annotate("text", 1, y = 8.2, label = "***", cex=14) + 
  annotate("text", 1.25, y = 1.1, label = "", cex=14) + 
  annotate("text", 1.425, y = 0.1, label = "a", cex=16) 
M.1.H.MPB.Ta.plot

M.2.H.MPB.Ta.plot <- ggplot(subset(HplotData, Sex=="male" & Treatment=="HSD" & Crosses==c("Parentaline", "Matriline", "Patriline") & variable=="TAG" & Generation=="F2"), aes(x=variable, y=MetabWt, fill=Crosses)) + 
  ...
  scale_y_continuous(limits=c(0, 30)) + 
  theme(legend.key.size =  unit(1, "in"), legend.text = element_text(size=18), legend.title = element_text(size=18, face="bold"), axis.text=element_text(size=25), axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.title.x = element_text(size=30), plot.title = element_text(size = rel(3), hjust = 0.5)) + 
  geom_signif(annotations = c("", "***", "***"), y_position = c(23, 24, 27), xmin=c(0.75, 1, 0.75), xmax=c(1, 1.25, 1.25), color="gray43", size=1.1, tip_length = 0.015, textsize=14, vjust = .25) + 
...
M.3.H.MPB.Ta.plot <- ggplot(subset(HplotData, Sex=="male" & Treatment=="HSD" & Crosses==c("Parentaline", "Matriline", "Patriline") & variable=="TAG" & Generation=="F3"), aes(x=variable, y=MetabWt, fill=Crosses)) + 
...
mylegend<-g_legend(M.1.H.MPB.Ta.plot)

Ta.M.H.plot <- grid.arrange(arrangeGrob(M.1.H.MPB.Ta.plot + theme(legend.position="none"), M.2.H.MPB.Ta.plot + theme(legend.position="none"), M.3.H.MPB.Ta.plot + theme(legend.position="none"), ncol=3, top=textGrob("HSD Males: Triglycerides", gp = gpar(fontface=2, fontsize=40)), bottom=textGrob("", gp = gpar(fontface=1, fontsize=25)), left=textGrob("Triglycerides/Fly Weight", rot=90, gp = gpar(fontface=1, fontsize=35))), mylegend, ncol=2, widths=c(10,2))

ggsave("HSD M1-3 TAG (rug).png", Ta.M.H.plot, width = 30, height = 10, units = "in")
```
Female Glycogen
```{r}
#Female Glycogen
F.1.H.MPB.Y.plot <- ggplot(subset(HplotData, Sex=="female" & Treatment=="HSD" & Crosses==c("Parentaline", "Matriline", "Patriline") & variable=="Glycogen" & Generation=="F1"), aes(x=variable, y=MetabWt, fill=Crosses)) + 
...
F.2.H.MPB.Y.plot <- ggplot(subset(HplotData, Sex=="female" & Treatment=="HSD" & Crosses==c("Parentaline", "Matriline", "Patriline") & variable=="Glycogen" & Generation=="F2"), aes(x=variable, y=MetabWt, fill=Crosses)) + 
...
F.3.H.MPB.Y.plot <- ggplot(subset(HplotData, Sex=="female" & Treatment=="HSD" & Crosses==c("Parentaline", "Matriline", "Patriline") & variable=="Glycogen" & Generation=="F3"), aes(x=variable, y=MetabWt, fill=Crosses)) + 
...
mylegend<-g_legend(F.1.H.MPB.Y.plot)

Y.F.H.plot <- grid.arrange(arrangeGrob(F.1.H.MPB.Y.plot + theme(legend.position="none"), F.2.H.MPB.Y.plot + theme(legend.position="none"), F.3.H.MPB.Y.plot + theme(legend.position="none"), ncol=3, top=textGrob("HSD Females: Glycogen", gp = gpar(fontface=2, fontsize=40)), bottom=textGrob("", gp = gpar(fontface=1, fontsize=25)), left=textGrob("Glycogen (µg/mL)/Fly Weight", rot=90, gp = gpar(fontface=1, fontsize=35))), mylegend, ncol=2, widths=c(10,2))

mylegend<-g_legend(F.2.H.MPB.Ta.plot)

TaY.F.H.plot <- grid.arrange(arrangeGrob(F.1.H.MPB.Y.plot + theme(legend.position="none"), F.2.H.MPB.Y.plot + theme(legend.position="none"), F.3.H.MPB.Y.plot + theme(legend.position="none"), F.1.H.MPB.Ta.plot + theme(legend.position="none"), F.2.H.MPB.Ta.plot + theme(legend.position="none"), F.3.H.MPB.Ta.plot + theme(legend.position="none"), ncol=3, top=textGrob("HSD Female Body Composition", gp = gpar(fontface=2, fontsize=40)), bottom=textGrob("", gp = gpar(fontface=1, fontsize=25)), left=textGrob("Triglycerides/Fly Weight                                  Glycogen/Fly Weight", rot=90, gp = gpar(fontface=1, fontsize=35))), mylegend, ncol=2, widths=c(10,2))

ggsave("HSD F1_3 Glyc and TAG (rug).png", TaY.F.H.plot, width = 30, height = 20, units = "in")
```
Male Glycogen
```{r}
#Male Glycogen
M.1.H.MPB.Y.plot <- ggplot(subset(HplotData, Sex=="male" & Treatment=="HSD" & Crosses==c("Parentaline", "Matriline", "Patriline") & variable=="Glycogen" & Generation=="F1"), aes(x=variable, y=MetabWt, fill=Crosses)) + 
...
M.2.H.MPB.Y.plot <- ggplot(subset(HplotData, Sex=="male" & Treatment=="HSD" & Crosses==c("Parentaline", "Matriline", "Patriline") & variable=="Glycogen" & Generation=="F2"), aes(x=variable, y=MetabWt, fill=Crosses)) + 
...
M.3.H.MPB.Y.plot <- ggplot(subset(HplotData, Sex=="male" & Treatment=="HSD" & Crosses==c("Parentaline", "Matriline", "Patriline") & variable=="Glycogen" & Generation=="F3"), aes(x=variable, y=MetabWt, fill=Crosses)) + 
...
Y.M.H.plot <- grid.arrange(arrangeGrob(M.1.H.MPB.Y.plot + theme(legend.position="none"), M.2.H.MPB.Y.plot + theme(legend.position="none"), M.3.H.MPB.Y.plot + theme(legend.position="none"), ncol=3, top=textGrob("HSD Males: Glycogen", gp = gpar(fontface=2, fontsize=40)), bottom=textGrob("", gp = gpar(fontface=1, fontsize=25)), left=textGrob("Glycogen (µg/mL)/Weight", rot=90, gp = gpar(fontface=1, fontsize=35))), mylegend, ncol=2, widths=c(10,2))

ggsave("HSD M1_3 Glyc (rug).png", Y.M.H.plot, width = 30, height = 10, units = "in")
...
HFitplotData <- Fitness.m %>% filter(grepl("HSD", Treatment))
HFitplotData$Crosses <- factor(HFitplotData$Crosses, levels=c("MhPh", "MhPc", "McPh"))
HFitplotData$Crosses <- revalue(HFitplotData$Crosses, c("MhPh"="Parentaline", "MhPc"="Matriline", "McPh"="Patriline"))
...
F.1.H.MPB.Fit.plot <- ggplot(subset(HFitplotData, Sex=="female" & Crosses==c("Parentaline", "Matriline", "Patriline") & variable=="Fitness" & Generation=="F1"), aes(x=variable, y=value, fill=Crosses)) +
...
F.2.H.MPB.Fit.plot <- ggplot(subset(HFitplotData, Sex=="female" & Crosses==c("Parentaline", "Matriline", "Patriline") & variable=="Fitness" & Generation=="F2"), aes(x=variable, y=value, fill=Crosses)) +
...
F.3.H.MPB.Fit.plot <- ggplot(subset(HFitplotData, Sex=="female" & Crosses==c("Parentaline", "Matriline", "Patriline") & variable=="Fitness" & Generation=="F3"), aes(x=variable, y=value, fill=Crosses)) +
...
mylegend<-g_legend(F.1.H.MPB.Fit.plot)

Fit.F.H.plot <- grid.arrange(arrangeGrob(F.1.H.MPB.Fit.plot + theme(legend.position="none"), F.2.H.MPB.Fit.plot + theme(legend.position="none"), F.3.H.MPB.Fit.plot + theme(legend.position="none"), ncol=3, top=textGrob("HSD Females: Fitness", gp = gpar(fontface=2, fontsize=40)), bottom=textGrob("", gp = gpar(fontface=1, fontsize=25)), left=textGrob("# of Offspring", rot=90, gp = gpar(fontface=1, fontsize=35))), mylegend, ncol=2, widths=c(10,2))

ggsave("HSD F1-3 Fitness (rug).png", Fit.F.H.plot, width = 30, height = 10, units = "in")



FitTaY.F.H.plot <- grid.arrange(arrangeGrob(F.1.H.MPB.Y.plot + theme(legend.position="none"), F.2.H.MPB.Y.plot + theme(legend.position="none"), F.3.H.MPB.Y.plot + theme(legend.position="none"), F.1.H.MPB.Ta.plot + theme(legend.position="none"), F.2.H.MPB.Ta.plot + theme(legend.position="none"), F.3.H.MPB.Ta.plot + theme(legend.position="none"), F.1.H.MPB.Fit.plot + theme(legend.position="none"), F.2.H.MPB.Fit.plot + theme(legend.position="none"), F.3.H.MPB.Fit.plot + theme(legend.position="none"), ncol=3, top=textGrob("HSD Female Offspring Responses", gp = gpar(fontface=2, fontsize=40)), bottom=textGrob("", gp = gpar(fontface=1, fontsize=25)), left=textGrob("# of Offspring                                            Triglycerides/Fly Weight                                            Glycogen/Fly Weight", rot=90, gp = gpar(fontface=1, fontsize=35))), mylegend, ncol=2, widths=c(10,2))

ggsave("HSD F1_3 Glyc TAG Fit (rug)2.png", FitTaY.F.H.plot, width = 30, height = 30, units = "in")
...
data <- data %>% filter(grepl("HSD", Treatment))
