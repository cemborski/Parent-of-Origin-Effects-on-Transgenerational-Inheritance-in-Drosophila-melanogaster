...
dataH <- data %>% filter(!grepl("NSD", Treatment))
dataN <- data %>% filter(!grepl("HSD", Treatment))
...
write.csv(NHresults, file = "Ch3 Contrasts N and H TaYTGF (FDR).csv")
...
write.csv(Results, file = "NH All Contrasts 180427.csv")
```
